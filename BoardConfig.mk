LOCAL_PATH := device/OPLUS/CPH2205

TARGET_BOARD_PLATFORM := mt6779               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME :=K79V1_64   	     # From ro.product.board
...
TARGET_2ND_CPU_VARIANT := cortex-a75         # Change the value to "generic" if build fails suddenly due to arch error
